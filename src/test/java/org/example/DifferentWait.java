...
//
//        browser.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));//webdriver exception gotle 1.no search element
//
//        WebDriverWait wait = new WebDriverWait(browser, Duration.ofSeconds(10));//time out exception
